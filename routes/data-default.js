...
"keunggulan" : [{
  ...
  "portofolio" : ["img/1","img/2","img/2","img/2","img/2"],
  "produk" : [{
    "id" : "5001",
    "nama" : "Barrier",
    "deskripsi" : "Barrier adalah produk precast yang digunakan sebagai pembatas jalan",
    "spesifikasi" : ["Mutu Beton K-350",
    ...
    "id" : "5002",
    "nama" : "U-DITCH",
    "deskripsi" : "Uditch adalah beton bertulang dengan bentuk penampang huruf U yang berfungsi sebagai saluran Drainase. Uditch memiliki daya lateral yang tinggi, mampu menahan beban dari tanah dan juga alirai air.",
    "spesifikasi" : ["Mutu beton K-350",
      "Mutu besi U-50 Hard Drawn Deformed Wire (HDDW)",
      "Cetak Basah dengan getaran frekuensi tinggi",
      "System join male-female"],
